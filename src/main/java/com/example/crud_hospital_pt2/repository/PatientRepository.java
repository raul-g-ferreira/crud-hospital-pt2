...
import com.example.crud_hospital_pt2.dto.report.PatientInternmentLocationDTO;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select  new com.example.crud_hospital_pt2.dto.report.PatientInternmentLocationDTO(" +
